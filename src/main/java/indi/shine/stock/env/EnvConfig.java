...
public class EnvConfig {
    ...
    private static final String MONGO_ADDRESS = "127.0.0.1:27017";
    public static final MongoUtil MONGO_UTIL = MongoUtil.getInstance(MONGO_ADDRESS, "", "");
    ...
    public static final ThreadUtil THREAD_UTIL = new ThreadUtil(10, 20);

    private static final String STOCK_K_URL = "https://push2his.eastmoney.com/api/qt/stock/kline/get?secid=%s.%s&ut=fa5fd1943c7b386f172d6893dbfba10b" +
    ...
    public static String kLineUrl(String code) {
       ...
       return String.format(STOCK_K_URL, t, code, 100000000);
    }
